...
When Mandiant (owned by Google) responds to a major breach, they don't deploy a polished, feature-complete tool. They deploy a *minimal* tool that answers the immediate question: "Is this system compromised?" Once that's answered, they iterate. In security, speed saves lives (or millions in remediation costs).
