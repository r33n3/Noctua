...
> **📖 Further Reading:** See the Agentic Engineering additional reading on foundations and the 12 Leverage Points for deeper discussion. Also see Anthropic's "Disrupting AI-Orchestrated Cyber Espionage" blog post (September 2025) and the detailed incident timeline in the [Reading List](resources/READING-LIST.md). This is the case study we'll use throughout Unit 1.
