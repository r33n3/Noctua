...
- Equivalent professional cybersecurity experience
- Working knowledge of command-line environments
- Familiarity with basic cybersecurity concepts (recommended)
...
CSEC 601 is an intensive graduate course designed to prepare security professionals for the agentic AI era. This course bridges three critical pillars: **Collaborative Critical Thinking (CCT)**, **Ethical AI**, and **Rapid Prototyping**. Students will learn to leverage Claude's advanced agentic capabilities—including Claude Code, the Claude Agent SDK, worktrees, subagents, and Model Context Protocol (MCP)—to build production-grade security tools in real time.

The course emphasizes hands-on learning (70% labs, 30% theory) starting from Week 1. Rather than studying AI security as an abstract discipline, students will build working prototypes immediately, applying structured critical thinking to AI-augmented security work. By the end of Semester 1, students will understand the modern AI landscape, design context-engineered solutions for real security challenges, audit AI systems for safety and fairness, and deliver production-ready security tools using agentic engineering patterns.

This is not a course about writing prompts. It is a course about orchestrating AI agents to solve security problems responsibly, ethically, and measurably.
...
### Unit 2: Context Engineering & Tool Design (Weeks 5–8)
...
### Unit 3: Ethical AI & Responsible AI (Weeks 9–12)
...
- Indicate in code comments where AI assisted (e.g., `# Claude-assisted error handling`)
- If you copy code from AI, cite it (e.g., `// Generated with Claude, adapted for our use case`)
