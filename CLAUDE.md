# CyberMinds-2026 — Claude Code Instructions
...
Reviews are conducted against the HTML lab files and the GitHub Pages site. The `course-feedback.md` in `noctura-course-review/` is the authoritative feedback log. Feedback items describe issues in terms of the HTML experience.
