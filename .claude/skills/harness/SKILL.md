...
name: harness
description: >
  Meta-skill for navigating the Think → Spec → Build → Retro cycle and
  auditing whether your workflow is self-correcting. Use when lost, when
  mistakes recur, or to check if retro output is actually changing your
  specs and thinking. Covers harness health check and phase navigation.
---
