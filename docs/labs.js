...
function buildSidebar(activeLink, pathPrefix) {
  ...
  const nav = [
    ...
    ['link', 'index.html', '<i data-lucide="home" class="licon"></i>Course Overview'],
    ['link', 'assessment.html', '<i data-lucide="file-text" class="licon"></i>Design Rationale'],
    ['nav-section', 'Semester 1: Foundations'],
    ['link', 'semester1.html', '<i data-lucide="layers" class="licon"></i>Semester 1 Overview'],
    ['sublink', 's1-unit1.html', '<i data-lucide="book-open" class="licon"></i>Unit 1: CCT Foundations'],
    ['sublink', 'lab-s1-unit1.html', '<i data-lucide="flask-conical" class="licon"></i>Lab: Unit 1'],
    ['sublink', 's1-unit2.html', '<i data-lucide="book-open" class="licon"></i>Unit 2: Context Engineering'],
    ['sublink', 'lab-s1-unit2.html', '<i data-lucide="flask-conical" class="licon"></i>Lab: Unit 2'],
    ['sublink', 's1-unit3.html', '<i data-lucide="book-open" class="licon"></i>Unit 3: Ethical AI'],
    ['sublink', 'lab-s1-unit3.html', '<i data-lucide="flask-conical" class="licon"></i>Lab: Unit 3'],
    ['sublink', 's1-unit4.html', '<i data-lucide="book-open" class="licon"></i>Unit 4: Rapid Prototyping'],
    ['sublink', 'lab-s1-unit4.html', '<i data-lucide="flask-conical" class="licon"></i>Lab: Unit 4'],
    ['nav-section', 'Semester 2: Advanced'],
    ['link', 'semester2.html', '<i data-lucide="layers" class="licon"></i>Semester 2 Overview'],
    ['sublink', 's2-unit5.html', '<i data-lucide="book-open" class="licon"></i>Unit 5: Multi-Agent'],
    ['sublink', 'lab-s2-unit5.html', '<i data-lucide="flask-conical" class="licon"></i>Lab: Unit 5'],
    ['sublink', 's2-unit6.html', '<i data-lucide="book-open" class="licon"></i>Unit 6: Attack vs Defend'],
    ['sublink', 'lab-s2-unit6.html', '<i data-lucide="flask-conical" class="licon"></i>Lab: Unit 6'],
    ['sublink', 's2-unit7.html', '<i data-lucide="book-open" class="licon"></i>Unit 7: Production Security'],
    ['sublink', 'lab-s2-unit7.html', '<i data-lucide="flask-conical" class="licon"></i>Lab: Unit 7'],
    ['sublink', 's2-unit8.html', '<i data-lucide="book-open" class="licon"></i>Unit 8: Capstone'],
    ['sublink', 'lab-s2-unit8.html', '<i data-lucide="flask-conical" class="licon"></i>Lab: Unit 8'],
    ['nav-section', 'Resources'],
    ['link', 'frameworks.html', '<i data-lucide="shield" class="licon"></i>Frameworks &amp; Protocols'],
    ['link', 'lab-setup.html', '<i data-lucide="terminal" class="licon"></i>Lab Setup Guide'],
    ['link', 'reading.html', '<i data-lucide="book-marked" class="licon"></i>Reading List'],
